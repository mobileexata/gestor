$(function() {
    ...
    $('.phone_with_ddd2').mask('(00) 0000-00000');
    ...
    $('.btnExcluir').on('click', function (e){
        ...
        if (!btn.attr('data-href'))
            throw "Propriedade de exclusão indefinida";
        $.confirm({
            title: 'Atenção!',
            content: (btn.attr('data-message-confirmation')) ? btn.attr('data-message-confirmation') : 'Deseja realmente excluir esse registro?',
            buttons: {
                sim: function () {
